...
<<<<<<< HEAD:Lib/Fullgame
        ...
        #If u turn activate the code above , u will be able to move the spaceship with ur mouse instead of the keys
=======
        # Player movement with arrow keys
>>>>>>> 057caa3f6cc50b6d1949ad2d06280a85684a6da3:Lib/game.py
        self.speedx = 0
        self.speedy = 0
...
# 
    ...
    # Shoot bullets button , and the powerup bullets
    def shoot(self):
...
bullet_img = pygame.image.load(path.join(img_dir, "bulletverkleint.png")).convert()
=======
...
#Powerup Images
power_images = {}
power_images['shield'] = pygame.image.load(path.join(img_dir, 'heartlife.png')).convert()
power_images['gun'] = pygame.image.load(path.join(img_dir, 'powerupbullett.png')).convert()
